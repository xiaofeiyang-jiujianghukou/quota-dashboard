...
// 套餐"额度水平"文案已移除：历史 DEFAULT_QUOTA 系拍脑袋参考（如 ark pro '5h 8,300万/…token'），
// 非官方实时值，易误导。额度文字一律只来自平台接口真值（各 provider 自行设置 quotaText），或 config.pricing 显式覆盖。

/** 套餐额度水平文案（仅取 config.pricing 显式覆盖，无则空——不虚构） */
